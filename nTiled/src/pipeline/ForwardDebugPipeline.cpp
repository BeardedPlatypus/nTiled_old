...
// ---------------------------------------------------------------------------
//  Constructor
ForwardDebugPipeline::ForwardDebugPipeline(state::State& state) :
  Pipeline(state),
  ...
  manager(TiledLightManager(state.world, state.view, 1200, 1200, this->projector)),
...
// ----------------------------------------------------------------------------
//  Object loading
void ForwardDebugPipeline::addObject(const world::Object& object) {
